...
public class IPBanCommand extends Command {
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        if (target == null) {
            ...
            gameClient.getHabbo().whisper(Emulator.getTexts().getValue("commands.success.cmd_ip_ban").replace("%username%", target.getUsername()).replace("%reason%", reason).replace("%minutes%", initial), RoomChatMessageBubbles.ALERT);
        }
