...
public class InvisibleCommand extends Command {
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        if (roomUnit.isInvisible()) {
            ...
            roomUnit.getRoom().addHabbo(gameClient.getHabbo());
            ...
            gameClient.getHabbo().getHabboStats().cache.remove("invisible");
        ...
        gameClient.getHabbo().getHabboStats().cache.put("invisible", true);
