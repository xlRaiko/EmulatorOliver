        ...
        if (this.habbo != null) {
            ...
            for (Habbo habbo : this.habbos) {
                if (habbo != null) {
                    ...
                    this.response.appendInt(habbo.getHabboInfo().getRank().getId());
                    this.response.appendInt(habbo.getHabboStats().getBannerId());
                    this.response.appendString(habbo.getHabboStats().getBannerColor());
                    this.response.appendInt(habbo.getHabboStats().getOrnamentId());
                    this.response.appendInt(habbo.getHabboStats().getColorId());
                    this.response.appendInt(habbo.getHabboStats().getUsernameIconId());
                    this.response.appendInt(habbo.getHabboStats().getUsernameEffectId());
                    this.response.appendInt(habbo.getHabboStats().hasActiveVip());
                    this.response.appendInt(habbo.getHabboStats().respectPointsReceived);
                    this.response.appendInt(habbo.getHabboStats().getKissesReceived());
                    this.response.appendString(habbo.getHabboStats().getProfileParameters());
