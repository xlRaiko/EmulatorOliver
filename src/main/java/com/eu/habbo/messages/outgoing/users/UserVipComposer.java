...
import com.eu.habbo.habbohotel.users.subscriptions.SubscriptionHabboVip;
import com.eu.habbo.messages.ServerMessage;
import com.eu.habbo.messages.outgoing.MessageComposer;
import com.eu.habbo.messages.outgoing.Outgoing;

public class UserVipComposer extends MessageComposer {
    ...
    public UserVipComposer(Habbo habbo) {
        this.habbo = habbo;
        this.subscriptionType = SubscriptionHabboVip.HABBO_VIP.toLowerCase();
        this.responseType = 0;
    }

    public UserVipComposer(Habbo habbo, String subscriptionType) {
        this.habbo = habbo;
        this.subscriptionType = subscriptionType;
        this.responseType = 0;
    }

    public UserVipComposer(Habbo habbo, String subscriptionType, int responseType) {
        this.habbo = habbo;
        this.subscriptionType = subscriptionType;
    ...
    protected ServerMessage composeInternal() {
        ...
        int responseType = ((this.responseType <= RESPONSE_TYPE_LOGIN) && timeRemaining > 0 && SubscriptionHabboVip.DISCOUNT_ENABLED && days <= SubscriptionHabboVip.DISCOUNT_DAYS_BEFORE_END) ? RESPONSE_TYPE_DISCOUNT_AVAILABLE : this.responseType;
