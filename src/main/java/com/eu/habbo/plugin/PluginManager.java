...
public class PluginManager {
    ...
    public static void globalOnConfigurationUpdated(EmulatorConfigUpdatedEvent event) {
        ...
        SubscriptionHabboVip.ACHIEVEMENT_NAME = Emulator.getConfig().getValue("subscriptions.vip.achievement", "VipClub");
        SubscriptionHabboVip.DISCOUNT_ENABLED = Emulator.getConfig().getBoolean("subscriptions.vip.discount.enabled", false);
        SubscriptionHabboVip.DISCOUNT_DAYS_BEFORE_END = Emulator.getConfig().getInt("subscriptions.vip.discount.days_before_end", 7);
        ...
        if (Emulator.isReady) {
            ...
            Emulator.getGameEnvironment().getAutoScheduler().reloadConfig();
    ...
    private void registerDefaultEvents() {
        try {
            ...
            this.methods.add(Game.class.getMethod("onUserTakeStepEvent", UserTakeStepEvent.class));
